        ...
        <>
            <section id="contact" className="section find-me-section">
                ...
                <div className="social-links fade-in-up">
                    <a href="https://www.linkedin.com/in/shaurya007/" className="social-link" title="LinkedIn" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://github.com/Shauryaa007" className="social-link" title="GitHub" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.instagram.com/shauryaa.cpp/" className="social-link" title="Instagram" target="_blank" rel="noopener noreferrer">
